...
function WhatsAppNavIcon() {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="white" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 2C6.477 2 2 6.477 2 12c0 1.89.525 3.66 1.438 5.168L2.05 21.95a.5.5 0 0 0 .612.612l4.782-1.388A9.954 9.954 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2z" />
    </svg>
  );
}
...
const Navbar = () => {
  ...
  return (
    <nav className="w-full z-50">
      ...
      {/* ── TOP ROW: white bar with logo, brand name, Get Quote, Login ── */}
          ...
          <div className="flex justify-between items-center py-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="leading-tight">
                <div className="font-bold text-base text-secondary-900" style={{ fontFamily: "'Cinzel', serif" }}>
                  AJIVA GLOBAL CARGO TRADING LLC
                </div>
                <div className="hidden sm:block text-xs text-secondary-500">
                  Freight Forwarding · Customs · GCC Road Freight
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <a href="#contact" className="btn-primary hidden sm:inline-block">
                Get a Quote
              </a>
              <Link
                to="/login"
                aria-label="Login"
                className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-gray-300 bg-white hover:bg-gray-50 transition-colors text-secondary-700 font-semibold text-sm"
              >
      ...
      {/* ── BOTTOM ROW: dark teal bar with nav links + social icons ── */}
        ...
        <div className="container-custom">
          <div className="hidden md:flex justify-between items-center py-3">
            ...
            <div className="flex items-center gap-3">
                ...
                href="https://wa.me/971544034567?text=Hello%2C%20I%20would%20like%20to%20inquire%20about%20your%20freight%20services."
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="flex items-center justify-center w-9 h-9 rounded-full border border-white/40 hover:border-white hover:bg-white/10 transition-all duration-200"
              >
                <WhatsAppNavIcon />
              </a>
              
                href="https://www.instagram.com/ajiva_global_cargo/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                href="https://www.linkedin.com/in/ajiva-global-26652a40a/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="flex items-center justify-center w-9 h-9 rounded-full border border-white/40 hover:border-white hover:bg-white/10 transition-all duration-200"
        ...
        {isOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 shadow-lg px-4 pb-4 pt-2">
            ...
            <div className="flex items-center gap-3 mt-4 pt-3 border-t border-gray-100">
              <a href="https://wa.me/971544034567" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="flex items-center justify-center w-9 h-9 rounded-full border border-gray-300 hover:bg-gray-100 transition-all">
              ...
              <a href="https://www.instagram.com/ajiva_global_cargo/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex items-center justify-center w-9 h-9 rounded-full border border-gray-300 hover:bg-gray-100 transition-all">
                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#2d7a5e" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                  <rect x="2" y="2" width="20" height="20" rx="5" ry="5" />
                  <circle cx="12" cy="12" r="4" />
                  <circle cx="17.5" cy="6.5" r="1" />
              ...
              <a href="https://www.linkedin.com/in/ajiva-global-26652a40a/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="flex items-center justify-center w-9 h-9 rounded-full border border-gray-300 hover:bg-gray-100 transition-all">
                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#2d7a5e" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" />
                  <rect x="2" y="9" width="4" height="12" />
                  <circle cx="4" cy="4" r="2" />
