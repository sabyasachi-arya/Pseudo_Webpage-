        ...
        <div className="relative h-[70vh] min-h-[520px] flex items-center">
          <div className="container-custom">
            <div className="max-w-3xl px-4">
              ...
              >
                From documentation and customs coordination to last-mile delivery, we keep shipments
                compliant and on schedule. Our team prioritizes clear milestones, proactive updates,
                and practical routing to reduce delays.
              </motion.p>
            </div>
          </div>
        </div>
            ...
            >
              {[...countries, ...countries].map((country, index) => (
                <div
                  ...
                  className="w-[260px] sm:w-[340px] lg:w-[420px] bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex-shrink-0"
                >
